            ...
            <div class="ng-scope">
                    <div class="ng-scope">
                        ...
                        <div class="main-content__first-screen">
                           ...
                           //             $p = ['Samuel J','Robert R ','Macy L','Jimmy TM','The Ace','Lenny L','Killer Player','Margerie M','Stiff T','Pinnacle Gamer','Jeanette P','Gordon R', 'Mary E', 'Daniel R', 'Sumit A'];
                                        $p = ['016***','017***','012***','012***','011***','016***','012***','018***','018***','011***','012***','016***', '011***', '011***','016***','017***','016***','012***','012***','011***','011***','017***','018***','016***','018***', '011***', '012***', '013***'];
                                        @endphp
                                        <li class="last-winners__item ng-scope">
                                            ...
                                            <div class="last-winners__info">
                                                ...
                                                <p class="last-winners__sum ng-binding">RM {{number_format(rand(5, 3000)/rand(1,10), 2)}}</p>
                                            </div>
                                        </li>
                                        @endfor
                                    @endif
                        ...
                        <nav class="category-panel__menu games-menu ng-isolate-scope" name="games_menu">
                            <ul class="games-menu__list">
                                ...
                                <li class="games-menu__item games-menu__item--woo_choice">
                                    <a class="games-menu__link games-menu__link--woo_choice" href="{{ route('frontend.game.list.category', 'hots') }}"> <i class="games-menu-icon games-menu-icon--woo_choice"></i> <span class="games-menu__title ng-scope" >@lang('app.hot_game')</span> </a>
                                </li>
                                ...
                                <li class="games-menu__item games-menu__item--new-games">
                                    <a class="games-menu__link games-menu__link--new-games" href="{{ route('frontend.game.list.category', 'news') }}"> <i class="games-menu-icon games-menu-icon--new-games"></i> <span class="games-menu__title ng-scope" >@lang('app.new')</span> </a>
                                </li>
                                <!-- end ngRepeat: filter_collection in gamesData.data.collections | limitTo: 9 -->
                    ...
                    <div class="providers ng-isolate-scope">
                        <div class="providers__panel">
                            ...
                            @php
                            $top_categories = ['netent', 'pragmatic', 'wazdan', 'isoftbet'];
                            @endphp
