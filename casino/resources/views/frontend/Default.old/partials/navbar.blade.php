                    ...
                    @if ($categories && count($categories))
                        @foreach($categories AS $index=>$category)
                            <li class="games-menu-mob__item games-menu-mob__item--woo_choice">
                                <a class="games-menu-mob__link games-menu-mob__link--woo_choice" scroll-up="" href="{{ route('frontend.game.list.category', $category->href) }}"> <span class="games-menu-mob__title ng-scope" >{{ $category->title }}</span> </a>
                            </li>
                        @endforeach
                    @endif
                </ul>
